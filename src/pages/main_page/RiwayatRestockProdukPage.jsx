                        ...
                        border-b-[3px] border-gray-200 grid grid-cols-3 gap-5 overflow-auto h-[440px]">
                            ...
                            <div className="bg-white w-96 py-2 px-1 rounded">
                                <div className="flex mb-10 w-full relative">
                                    <p className="mr-32 font-semibold text-[#403E8A]">Kayu</p>
                                    <p className="text-[10px] text-[#8C8BB4] absolute left-[310px] top-1">April
                                        1,2024</p>
                                </div>
                                ...
                                <div className="flex text-[11px] font-medium text-[#403E8A] mb-2 relative">
                                    ...
                                    <p className="font-semibold text-[#8C8BB4] absolute left-32">ABC Supplier</p>
                                </div>
                                ...
                                <div className="flex text-[11px] font-medium text-[#403E8A] mb-5 relative">
                                    ...
                                    <p className="absolute left-28">:</p>
                                    <p className="font-semibold text-[#8C8BB4] absolute left-32">+62-1234567890</p>
                                </div>

                                <div className="flex text-[11px] font-medium text-[#403E8A] mb-2 relative">
                                    <p className="">Metode Pengiriman</p>
                                    <p className="absolute left-28">:</p>
                                    <p className="font-semibold text-[#8C8BB4] absolute left-32">Penngiriman Darat</p>
                                </div>
                                ...
                                <div className="flex text-[11px] font-medium text-[#403E8A] mb-2 relative">
                                    ...
                                    <p className="absolute left-28">:</p>
                                    <p className="font-semibold text-[#8C8BB4] absolute left-32">
                                        Jl. Pengiriman No. 456, Kota Pengiriman</p>
                                </div>

                                <div className="flex text-[11px] font-medium text-[#403E8A] mb-2 relative">
                                    <p className="">Metode Pembayaran</p>
                                    <p className="absolute left-28">:</p>
                                    <p className="font-semibold text-[#8C8BB4] absolute left-32">Transfer Bank</p>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div className="text-xs py-4 px-6">
                                        <ul className="flex">
                                            <li>Kayu</li>
                                            <li className="mx-16">100 Batang</li>
