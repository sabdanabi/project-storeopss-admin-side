...
export function ProductSelectionTable({ onProductSelect }) {
    ...
    const handleSelect = () => {
        ...
        onProductSelect(selectedProducts); // Mengirim data produk yang dipilih ke parent
    };
            ...
            <div>
                ...
                <div>
                    {isLoading ? (
                        ...
                        <div className="overflow-hidden h-[600px] border">
                            <table className="w-[600px] bg-white mt-7 table-fixed">
                                <thead>
                                <tr>
                            ...
                            >
                                <span
                                    className="text-white font-medium text-sm group-hover:text-[#1A4F8B]">Pilih Produk</span>
                            </button>
                        </div>
                    ) : (
                        <div className="flex items-center justify-center h-full">
