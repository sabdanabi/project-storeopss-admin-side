        ...
        <>
            <div className="flex-shrink-0 hidden w-75 bg-white  border-[3px] border-gray-200 md:block">
                <div className="px-5 py-6">
                    <img src="/assets_img/Logo.png" className="w-32 ml-0"/>
                    <nav className="mt-7">
                        <div className={`flex w-[100%] hover:bg-[#F2F6FF] group pl-5 h-11 rounded-lg mb-2 group 
                        ${isTransaksiPage ? 'bg-[#F2F6FF]' : ''}`}>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5}
                                 stroke="currentColor" className={`text-[#8C95A4] w-6 h-7 mt-2 group-hover:text-[#3E6BC1] 
                                 ${isTransaksiPage ? 'text-[#3E6BC1] ' : ''}`}>
                                <path strokeLinecap="round" strokeLinejoin="round"
                                      d="M3 7.5 7.5 3m0 0L12 7.5M7.5 3v13.5m13.5 0L16.5 21m0 0L12 16.5m4.5 4.5V7.5"/>
                            </svg>

                            <a href="/transaksi-page"
                               className={`block py-3 pl-3 pr-4 text-sm font-medium text-[#8C95A4] rounded-lg group-hover:text-[#3E6BC1] 
                                   ${isTransaksiPage ? 'text-[#3E6BC1] ' : ''}`}>Transaksi</a>
                        </div>
                        ...
                        ${isPersediaanPage ? 'bg-[#F2F6FF]' : ''}`}>
                            ...
                            <a href="/"
                               className={`block py-3 pl-3 pr-4 text-sm font-medium text-[#8C95A4] rounded-lg group-hover:text-[#3e6bc1] 
                                   ${isPersediaanPage ? 'text-[#3e6bc1] ' : ''}`}>Persedian</a>
                        </div>
                        ...
                        ${isLaporanPage ? 'bg-[#F2F6FF]' : ''}`}>
                            ...
                            <a href="/laporan-page"
                               className={`block py-3 pl-3 pr-4 text-sm font-medium text-[#8C95A4] rounded-lg group-hover:text-[#3e6bc1] 
                           ${isLaporanPage ? 'text-[#3e6bc1] ' : ''}`}>Laporan Stock</a>
                        </div>
                        ...
                        ${isStatisticPage ? 'bg-[#F2F6FF]' : ''}`}>
                            ...
                            <a href="/statistic-page"
                               className={`block py-3 pl-3 pr-4 text-sm font-medium text-[#8C95A4] rounded-lg group-hover:text-[#3e6bc1]  
                               ${isStatisticPage ? 'text-[#3e6bc1] ' : ''}`}>Statistic</a>
                        </div>
                        ...
                        ${isRiwayatTambahProdukPage ? 'bg-[#F2F6FF]' : ''}`}>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5}
                                 stroke="currentColor" className={`text-[#8C95A4] w-6 h-7 mt-2 group-hover:text-[#3e6bc1]  
                                 ${isRiwayatTambahProdukPage ? 'text-[#3e6bc1] ' : ''}`}>
                                <path strokeLinecap="round" strokeLinejoin="round"
                            ...
                            <a href="/riwayat-tambah-produk-page"
                               className={`block py-3 pl-3 pr-4 text-sm font-medium text-[#8C95A4] rounded-lg group-hover:text-[#3e6bc1] 
                                    ${isRiwayatTambahProdukPage ? 'text-[#3e6bc1] ' : ''}`}>History Masuk Produk</a>
                        </div>
                        ...
                        ${isRiwayatRestockPage ? 'bg-[#F2F6FF]' : ''}`}>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5}
                                 stroke="currentColor" className={`text-[#8C95A4] w-6 h-7 mt-2 group-hover:text-[#3e6bc1]  
                                 ${isRiwayatRestockPage ? 'text-[#3e6bc1] ' : ''}`}>
                                <path strokeLinecap="round" strokeLinejoin="round"
                            ...
                            <a href="/riwayat-restock-page"
                               className={`block py-3 pl-3 pr-4 text-sm font-medium text-[#8C95A4] rounded-lg group-hover:text-[#3e6bc1] 
                               ${isRiwayatRestockPage ? 'text-[#3e6bc1] ' : ''}`}>Histori Pembaruan Stok</a>
                        </div>
